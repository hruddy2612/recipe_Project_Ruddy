...
#run the program
print_recipe()
#"/Users/heatherruddy/Downloads/HCI Python/Recipe Project/recipe_Project_Ruddy/recipe2.csv")

# Main

#import CSV file to pandas (make sure excell is in csv format)
df = pd.read_csv ("/Users/heatherruddy/Documents/GitHub/recipe_Project_Ruddy/main_files/images/recipe2.csv")
